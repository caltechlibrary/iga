...
with open('../../person-names/chinese-surnames.txt', 'r') as file:
...
correct = sum(1 for value in labels if value == 'PERSON')
...
# import regex
# p = regex.compile(r'\L<alternatives>', alternatives=names)
# test = '吴晟'
# print(p.search(test))
